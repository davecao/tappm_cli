"""
    This module is modified from logger used in Package Prody
"""
import sys
import math
import time
...
__all__ = ['LOGGING_LEVELS', 'Console']
...
class Console(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        # close existed handler
        for handler in logger.handlers:
            handler.close()
        # reset to empty
        logger.handlers = []
        # Create new streamhandler
        console = logging.StreamHandler()
        # logging.DEBUG is default
        self._level = LOGGING_LEVELS[kwargs.get('level', 'debug')]
    ...
    def info(self, msg, propagate=False):
    ...
    def critical(self, msg, propagate=False):
    ...
    def debug(self, msg, propagate=False):
    ...
    def warning(self, msg, propagate=False):
    ...
    def error(self, msg, propagate=False):
    ...
    def report(self, msg='Completed in %.2fs.', label=None):
        ...
        self.info(msg % (time.time() - self._times[label]))
